CREATE DATABASE  IF NOT EXISTS `bonproject` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `bonproject`;
...
CREATE TABLE `odap` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id_idx` (`user_id`),
  KEY `gichulset_id_idx` (`gichulset_id`),
  CONSTRAINT `gichulset_id` FOREIGN KEY (`gichulset_id`) REFERENCES `gichulset` (`id`),
...
-- Dump completed on 2025-07-02 12:06:31
